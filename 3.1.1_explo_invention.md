...
Les concepts d'artefact technologique, d'artefact social, de capacité d'action et d'état d'un jeu de données étant définis, nous pouvons désormais présenter notre méthode de représentation graphique de la structure statique des systèmes à l'oeuvre dans l'usage de l'open data.
...
Concept de **séquences d'articulation*(interlocking sequences)**, et de **complémentarités(complementarities)**
