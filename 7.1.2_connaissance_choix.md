# 7. Evaluation de la capacité d'une base de connaissance à lever les barrières socio-techniques qui freinent l'innovation de services issues de l'open data
